...
var cityPath = require(path.join(geodatadir, 'geoip-city.dat'));
var city6Path = require(path.join(geodatadir, 'geoip-city6.dat'));
var countryPath = require(path.join(geodatadir, 'geoip-country.dat'));
var country6Path = require(path.join(geodatadir, 'geoip-country6.dat'));
